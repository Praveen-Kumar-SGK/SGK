...
urlpatterns = [
    ...
    re_path(r"ai\/extractor\/$", views.cep_single.as_view(), name='ai_cep'),
    ...
    re_path(r"ascensia_cep\/$", views.ascensia_cep, name='ascensia_cep'),
    re_path(r"danone_cep\/$", views.danone_cep, name='danone_cep'),
]
